...
formatter.step({
  "name": "user enters vin number as \"21343532543512341\"",
  "keyword": "And "
});
formatter.match({
...
formatter.scenario({
  "name": "Validate AUTO LOAN CALCULATOR under FINANCING menu",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "user selects \"Choose Your Loan Term\" as \"60 Months\"",
  "keyword": "And "
});
formatter.match({
  "location": "CarvanaSteps.userSelectsAs(String,String)"
...
formatter.step({
  "name": "user should see the monthly payment as \"144.00\"",
  "keyword": "Then "
});
formatter.match({
